...
- Replace `Tetiana-Hishchak` with your Github username in the [DEMO LINK](https://Tetiana-Hishchakc.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
