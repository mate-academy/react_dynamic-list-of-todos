...
- Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://nikita-parkhomenko.github.io/react_dynamic-list-of-todos/)
...
1. Each todo has a button to select a user but `

` is stored in the `App`. (pass a callback to the `TodoList`)
