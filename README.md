...
1. Check how the `wait` function used in the `api.ts` to ensure that `Loader` works as expected;
...
P-Nazar.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
