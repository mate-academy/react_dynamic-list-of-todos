...
+ Load [the todos](https://mate-academy.github.io/react_dynamic-list-of-todos/api/todos.json) when the `App` is
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://mrsvolodya.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
