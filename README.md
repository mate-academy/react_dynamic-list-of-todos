...
- Replace `<your_account>` with your Github username in the [Nikola S. DEMO LINK](https://Nikola57.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
