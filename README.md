...
You are given the markup for the `App`, `TodosList`, `TodoFilter`, `TodomodalIsOpen`
...
1. When the `Show` button is clicked open the `TodomodalIsOpen` with a selected `todo`;
...
1. `x` button should close the modalIsOpen;
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://NikaNika12.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
