...
- Replace `<your_account>` with your Github username in the
  [DEMO LINK](https://Danylo-Dziuban.github.io/react_dynamic-list-of-todos/)
...
1. `CurrentUser` component receives `userId` as a prop and loads user details from [GET user endpoint](https://mate.academy/students-api/users/) (replace 1 with a given `userId`).
