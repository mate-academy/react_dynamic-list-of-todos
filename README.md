...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://vl-tsr.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
https://github.com/Vl-Tsr/react_dynamic-list-of-todos
