...
1. Show the Loader while waiting for the user;2
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://mikezhylka.github.io/react_dynamic-list-of-todos/) and add it to the PR description.
