...
export class TodoList extends React.Component<Props, State> {
  ...
  visiblteTodos = (todo: Todo): boolean => {
    const { searchField, selectOption } = this.state;
    const { title, completed } = todo;
    const search: boolean = title.toUpperCase().includes(searchField.toUpperCase());
  ...
  render() {
    ...
    const visibleTodos = todos.filter(this.visiblteTodos);
